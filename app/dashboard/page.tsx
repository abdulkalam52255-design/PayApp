    ...
    <AppShell>
      <div className="px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-2 gap-3 lg:grid-cols-4">
          ...
          <StatsCard label="Submissions This Month" value={4} icon={FileText} accent="default" trend={{ value: '+2 vs last month', positive: true }} />
          <StatsCard label="Critical Issues Found" value={3} icon={AlertOctagon} accent="red" />
          <StatsCard label="Reports Unlocked" value={2} icon={Unlock} accent="green" />
        </div>
          ...
          <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-0.5 text-xs text-amber-800 dark:text-amber-400">
                    2 critical issues in Riverside Medical / March 2025. Review before submitting.
                  </p>
                  <Link
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-[hsl(222,20%,11%)]">
              ...
              <div className="mt-3 space-y-2.5">
                {[
                  { label: 'Submissions', used: 4, total: 10, color: 'bg-blue-600' },
                  { label: 'Unlocks', used: 7, total: 10, color: 'bg-green-600' },
                ].map((item) => (
                  <div key={item.label}>
